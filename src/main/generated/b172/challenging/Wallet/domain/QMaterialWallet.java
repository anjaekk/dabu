...
public class QMaterialWallet extends EntityPathBase<MaterialWallet> {
    ...
    private static final long serialVersionUID = 1434419079L;
    ...
    public final b172.challenging.Home.domain.QHomeMaterial homeMaterial;
    ...
    public QMaterialWallet(Class<? extends MaterialWallet> type, PathMetadata metadata, PathInits inits) {
        ...
        this.homeMaterial = inits.isInitialized("homeMaterial") ? new b172.challenging.Home.domain.QHomeMaterial(forProperty("homeMaterial"), inits.get("homeMaterial")) : null;
